...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "Introducing Cortex Linux: The AI-Native Operating System",
    seoTitle: "Introducing Cortex Linux: AI-Powered System Administration | Cortex Linux",
    seoDescription: "Cortex Linux transforms system administration with natural language commands. Install software, configure systems, and troubleshoot—all without memorizing commands.",
    excerpt: "What if Linux could just understand what you want? That question led us to build Cortex Linux—an AI-native distribution that transforms system administration through natural language.",
    content: `## The Problem We Set Out to Solve
...
**Try the beta:** Installation instructions in the README. Works on Debian, Ubuntu, and derivatives.
...
`,
    ...
    image: "/stock_images/ai_terminal_hero.jpg",
    imageAlt: "Cortex Linux AI-powered terminal interface",
    tags: ["Launch", "AI-Native", "Natural Language", "Linux", "Open Source", "Announcement"],
    relatedPosts: ["what-ai-native-linux-means", "ml-workloads-without-config-hell", "linux-security-best-practices"]
  },
  {
    id: "1",
