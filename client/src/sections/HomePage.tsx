...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  const features = [
    { icon: Zap, title: "Execute Any Task", description: "From shell scripts to system configuration to data analysis — describe what you need and CX Linux translates it into precise Linux commands.", code: "cx \"find all files larger than 100MB modified in the last week\"\ncx \"analyze nginx logs for top 10 error sources\"" },
    { icon: Wand2, title: "Intelligent Automation", description: "Transform complex multi-step workflows into simple natural language descriptions. CX Linux chains commands intelligently with error handling.", code: "cx \"deploy my app: build, run tests, backup db, then restart services\"\ncx \"set up a Python dev environment with virtualenv and requirements\"" },
  ...
  return (
    <div className="min-h-screen bg-black text-white noise-texture">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              From automation to analysis, configuration to deployment — CX Linux adapts to your workflow
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                detail: "If Linux can do it, CX Linux can execute it."
              }
            ].map((item, index) => (
              <motion.div
                key={item.title}
      ...
      {/* New to CX Linux? - Getting Started Preview */}
            ...
            <div className="relative p-8 md:p-10 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-blue/30 transition-all duration-300">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    href="/blog/install-cx-linux-beginner-guide"
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto">
              See why developers choose CX Linux over traditional alternatives.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="glass-card rounded-xl p-6">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/cxlinux-ai/cx/blob/main/CONTRIBUTING.md"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section id="ai-processing" className="py-32 px-4 border-t border-white/5 overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Describe what you need in plain English. CX Linux translates your intent into perfectly optimized system commands — instantly and safely.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-4 border-t border-white/5 relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: FaDiscord, name: "Discord", color: "hover:border-indigo-500", link: "https://discord.gg/cxlinux" },
              { icon: FaTwitter, name: "Twitter", color: "hover:border-sky-500", link: "https://twitter.com/cxlinux" },
              { icon: Github, name: "GitHub", color: "hover:border-gray-500", link: "https://github.com/cxlinux-ai/cx/discussions" },
            ].map((platform, i) => (
              <a
                key={i}
                href={platform.link}
      ...
      <section id="join" className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-10">Start shipping faster with CX Linux. Free forever.</p>
      ...
      <footer className="border-t border-white/10 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="https://github.com/cxlinux-ai/cx" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" data-testid="footer-link-get-started">Get Started</a></li>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              <a href="https://twitter.com/cxlinux" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" data-testid="footer-social-twitter">
                <FaTwitter size={20} />
              </a>
              <a href="https://github.com/cxlinux-ai/cx" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" data-testid="footer-social-github">
                <Github size={20} />
              </a>
              <a href="https://discord.gg/cxlinux" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" data-testid="footer-social-discord">
                <FaDiscord size={20} />
              </a>
            </div>
          </div>
