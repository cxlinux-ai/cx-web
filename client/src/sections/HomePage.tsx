    ...
    <div className="min-h-screen bg-black text-white noise-texture">
      ...
      <section id="home" className={`min-h-screen flex flex-col justify-center items-center ${SECTION_PADDING.hero} px-2 sm:px-4 relative overflow-hidden`}>
        ...
        <div className="w-full max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            <span className="block text-white text-[32px] sm:text-[48px] md:text-[64px] lg:text-[82px] font-extrabold">THE AI-NATIVE</span>
            <span className="block gradient-text text-[32px] sm:text-[48px] md:text-[64px] lg:text-[82px] font-extrabold">OPERATING SYSTEM</span>
          </motion.h1>
          ...
          >
            Tell your server what you want. It figures out the rest. Natural language system administration
            with hardware detection, dependency resolution, and instant rollback.
          </motion.p>
