  ...
  return (
    <div className="relative min-h-screen pt-20 pb-16 bg-[#08080A] text-white overflow-hidden">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[350px] bg-[#2F6BFF]/[0.025] rounded-full blur-[100px]" />
      </div>
      <div className="relative max-w-4xl mx-auto px-4">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            ...
            <span className="bg-gradient-to-r from-[#7AA0FF] to-[#B9CCFF] bg-clip-text text-transparent">Service</span>
          </h1>
