      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div id="pricing-faq-header" className="text-center mb-12">
          ...
          >
            ...
            <span className="text-[#7AA0FF]">FAQ</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-r from-[#2F6BFF]/10 to-[#2257E0]/10 border border-[#2F6BFF]/30 rounded-2xl p-8 text-center"
        >
          <MessageSquare className="w-12 h-12 text-[#7AA0FF] mx-auto mb-4" />
