      ...
      <section className="py-16 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <motion.a
            ...
            href="/downloads/cortex-hackathon-rules-2026.pdf"
            download
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-blue hover:opacity-90 rounded-xl text-white font-medium transition-all shadow-[0_0_20px_rgba(0,102,255,0.3)] hover:shadow-[0_0_30px_rgba(0,102,255,0.5)]"
