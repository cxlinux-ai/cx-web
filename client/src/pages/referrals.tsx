...
import { Users, Gift, Trophy, Zap, ArrowRight, CheckCircle2, Shield } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          {showDashboard && referralCode ? (
            <div className="space-y-12">
              {/* Verification Status */}
              <VerificationStatus referralCode={referralCode} />

              {/* Dashboard */}
              <ReferralDashboard referralCode={referralCode} />

              {/* Reward Tiers */}
              <RewardTiers referralCode={referralCode} />
