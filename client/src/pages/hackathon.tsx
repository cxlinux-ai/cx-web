...
const GITHUB_URL = "https://github.com/cxlinux-ai/cx";
const GITHUB_ISSUES_URL = "https://github.com/cxlinux-ai/cx/issues";
  ...
  const tracks = [
    {
      icon: Terminal,
      title: "CLI Commands",
      description: "Build new natural language commands for CX Linux",
      difficulty: "Beginner",
          ...
          >
            ...
            <div className="p-6 font-mono text-sm">
              ...
              <p className="text-gray-400 mt-2">
                <span className="text-emerald-400">$</span> cd cx
              </p>
              <p className="text-gray-400 mt-2">
