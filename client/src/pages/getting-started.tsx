...
export default function GettingStarted() {
  const quickNavCards = [
    ...
    },
    {
      ...
      description: "Tell CX Linux what you need—from server config to automation to anything in between",
      icon: Terminal,
    ...
    },
    {
      ...
      description: "See how CX Linux handles any Linux operation through natural language",
      icon: Sparkles,
  ...
  const gettingStartedSteps = [
    ...
    },
    {
      ...
      description: "Confirm that CX Linux is properly installed and all components are functioning correctly.",
      details: [
    ...
    },
    {
      ...
      description: "Experience the power of intent-based computing. Simply describe what you want to accomplish—CX Linux handles the rest.",
      details: [
    ...
    },
    {
      ...
      description: "CX Linux is your intelligent Linux assistant. Whatever you need to accomplish, just ask.",
      details: [
  ...
  const learningPaths = [
    {
      title: "Beginner Path",
      icon: GraduationCap,
      description: "New to Linux? Let CX Linux be your guide.",
      color: "from-green-500 to-emerald-500",
      resources: [
        { title: "Getting Started with CX Linux", link: "/blog/getting-started-cortex-first-workflow" },
        ...
        { title: "CX Linux for Students", link: "/blog/cortex-linux-for-students" },
    ...
    },
    {
      ...
      resources: [
        ...
        { title: "Security Hardening with CX Linux", link: "/blog" },
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            ...
            or anything else. CX Linux understands your intent and makes it happen.
          </p>
        </motion.div>
      </section>
