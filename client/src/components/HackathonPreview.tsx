      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div 
            ...
            style={{
              background: "radial-gradient(ellipse at center, rgba(139,92,246,0.08), rgba(59,130,246,0.05), transparent 70%)",
              filter: "blur(30px)",
              transform: "translateZ(-15px)",
            }}
          />
          
          {/* Animated gradient border - purple to blue 3D effect */}
          <div 
            className="absolute -inset-[1px] rounded-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500"
            style={{
          ...
          >
            ...
            <div 
              className="absolute top-0 left-0 right-0 h-1/3 opacity-30 group-hover:opacity-40 transition-opacity duration-500"
              style={{
                background: "linear-gradient(135deg, rgba(139,92,246,0.08), rgba(59,130,246,0.06), transparent)",
                filter: "blur(20px)",
              }}
            />
            ...
            <div 
              className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-40 opacity-60 group-hover:opacity-80 transition-opacity duration-500"
              style={{
                background: "radial-gradient(ellipse at top, rgba(59,130,246,0.06), transparent)",
                filter: "blur(25px)",
              }}
            />
            ...
            <div className="relative px-8 py-10 md:px-12 md:py-14">
              ...
              <div className="flex justify-center mb-8">
                <motion.div 
                  className="relative inline-flex items-center gap-2 px-5 py-2 rounded-full bg-blue-500/10 border border-blue-500/20"
              ...
              <div className="mb-10">
                ...
                <div className="flex gap-3 sm:gap-4 justify-center">
                  {Object.entries(countdown).map(([unit, value]) => (
                    ...
                    >
                      <div 
                        className="relative bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-xl p-4 sm:p-5 min-w-[70px] sm:min-w-[90px] group-hover/timer:border-blue-500/20 transition-all duration-300 overflow-hidden"
                        style={{ 
                          boxShadow: "0 8px 32px rgba(0,0,0,0.4), 0 4px 16px rgba(59,130,246,0.1), inset 0 1px 0 rgba(255,255,255,0.05)",
                          transform: "perspective(500px) rotateX(2deg)",
                        }}
                      >
                        {/* 3D depth layers - back numbers */}
                        <span 
                          className="absolute inset-0 flex items-center justify-center font-bold text-blue-400/[0.08] font-mono select-none"
                          style={{ fontSize: '70px', transform: 'translateZ(-30px) scale(1.15)' }}
                          aria-hidden="true"
                        >
                          {String(value).padStart(2, "0")}
                        </span>
                        <span 
                          className="absolute inset-0 flex items-center justify-center font-bold text-blue-400/[0.15] font-mono select-none"
                          style={{ fontSize: '70px', transform: 'translateY(2px) translateX(1px)' }}
                          aria-hidden="true"
                        >
                          {String(value).padStart(2, "0")}
                        </span>
                        ...
                        <span 
                          className="relative font-bold text-blue-400 font-mono"
                          style={{ 
                            fontSize: '70px',
                            textShadow: '0 0 20px rgba(59,130,246,0.5), 0 0 40px rgba(59,130,246,0.3), 0 4px 8px rgba(0,0,0,0.3)',
                          }}
                        >
                          {String(value).padStart(2, "0")}
                        </span>
