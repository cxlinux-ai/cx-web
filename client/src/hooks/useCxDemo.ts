...
const SYSTEM_CONTEXT = `You are CX Linux, an AI-powered Linux package manager assistant. When a user asks for installation or configuration help, respond with ONLY the required shell commands in a single code block. Do NOT include:
  ...
  const sendMessage = useCallback(async (content: string) => {
    ...
    try {
      const apiMessages = [
        ...
        { role: 'assistant', content: 'Understood. I will help with CX Linux package management.' },
