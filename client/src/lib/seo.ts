...
export const seoConfigs = {
  ...
  hackathon: {
    ...
    jsonLd: {
      ...
      description: 'The first-ever AI Linux Hackathon. A two-phase, 17-week program: Phase 1 (Ideathon, Weeks 1-4) generates monetizable feature ideas. After a 1-month break, Phase 2 (Hackathon, Weeks 9-17) builds real code via GitHub PRs. $15,000 in prizes. Free to participate, open to developers worldwide.',
