...
sidebar_position: 4
title: Code Style
description: Coding standards and style guide for CX Linux contributors.
keywords: [code style, standards, formatting, rust, guidelines]
---

# Code Style

This guide defines coding standards for CX Linux. Consistent style makes code easier to read, review, and maintain.
