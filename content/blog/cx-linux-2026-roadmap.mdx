...
This requires a lightweight agent running on each managed server that reports state changes to the CX coordinator. The agent uses less than 50MB of RAM.
...
Plugins are TypeScript modules that declare their capabilities, required permissions, and LLM prompts. We'll ship a set of first-party plugins as reference implementations.
...
[Follow our progress on Discord →](https://discord.gg/q4FUyBW6z)
