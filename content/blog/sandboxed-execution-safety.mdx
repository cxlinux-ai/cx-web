...
Our safety model is layered: every command runs sandboxed, is previewed before execution, and is fully reversible. Destructive patterns are blocked by default and nothing touches your system without your explicit approval.

Safety isn't a single feature, it's enforced at every layer between your request and your system.
