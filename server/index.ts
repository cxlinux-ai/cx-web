...
// Discord bot removed - import { startBot } from "./discord-bot/index.js";
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.anthropic.com", "https://api.stripe.com", "wss:", "ws:"],
...
(async () => {
  ...
  // Discord bot removed - no longer starting
})();
