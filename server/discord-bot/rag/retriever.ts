...
const KNOWLEDGE_BASE: Array<{
  ...
  // === OVERVIEW ===
  {
    keywords: ["what is", "cx linux", "about", "explain", "tell me", "overview", "introduction"],
    category: "overview",
    priority: 10,
  ...
  },
  {
    ...
    category: "community",
    priority: 7,
    content: `CX Linux is fully open source. Check out our GitHub at github.com/cxlinux-ai/cx-core. You can browse the code, report issues, submit pull requests, or fork it for your own projects. We welcome contributions of all kinds, from code to documentation to translations.`,
  },
  {
