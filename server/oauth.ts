...
const DISCORD_REDIRECT_URI = process.env.DISCORD_REDIRECT_URI || "https://cxlinux.com/api/oauth/discord/callback";
const DISCORD_SERVER_ID = process.env.DISCORD_SERVER_ID || ""; // Your Discord server ID
const DISCORD_BOT_TOKEN = process.env.DISCORD_BOT_TOKEN || "";

const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_ID || "";
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || "";
const GITHUB_REDIRECT_URI = process.env.GITHUB_REDIRECT_URI || "https://cxlinux.com/api/oauth/github/callback";

const FRONTEND_URL = process.env.FRONTEND_URL || "https://cxlinux.com";
