...
| `/beta` | Interactive demo - try CX Linux with your own API key |
...
### Features
- **Natural Language Input**: Enter commands like "cx install docker" or "cx setup python for ML"
...
- No data is sent to CX Linux servers
...
- [CX Linux CLI](https://github.com/cxlinux-ai/cx) - The main CX Linux project
